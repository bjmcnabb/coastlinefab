...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ['0.0.0.0','0.0.0.0:8000','127.0.0.1','localhost','coastlinefab-production.up.railway.app',' coastline-fabricators.onrender.com','.coastlinefabricators.ca']
